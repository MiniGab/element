        ...
        ? _c(
            "div",
            {
              ...
              style: {
                ...
                width: "100%",
                "margin-left": _vm.inputMarginLeft + "px"
              }
            },
            [
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    resetInputWidth: function resetInputWidth() {
      var inputBoundingClientRect = this.$refs.reference.$el.querySelector('input').getBoundingClientRect();
      var componentBoundingClientRect = this.$refs.reference.$el.getBoundingClientRect();
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      if (reference && reference.$el) {
        _this14.inputWidth = reference.$el.querySelector('input').getBoundingClientRect().width;
      }
    });
    this.setSelected();
  },
